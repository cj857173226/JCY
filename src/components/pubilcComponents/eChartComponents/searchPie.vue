...
export default {
    ...
    methods:{
        ...
        getData(){
            var _this = this;
            this.data = this.echartData.budget2011List;
            this.names = this.echartData.names;
            this.initChart();
            // this.axios({
            //     method:'get',
            //     url:'http://echarts.baidu.com/data/asset/data/obama_budget_proposal_2012.list.json'
